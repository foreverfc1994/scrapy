...
class DoubanGroupSpider(CrawlSpider):
    ...
    start_urls = [
        ...
        #'https://www.douban.com/people/1174782/',
    ...
    rules = (
        Rule(author_extract, follow=True, callback='parse_author', process_request='add_cookies'),
